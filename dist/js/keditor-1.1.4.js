 ...
 * @option {Boolean} tabComponentsTitle Title for Components tab
 ...
 *     }
 * }
 * @option {String} showContainers Show Containers selection tab
...
(function ($) {
    ...
    KEditor.prototype = {
        ...
        renderSnippets: function (resp) {
            ...
            var tabs = '<ul id="keditor-snippets-type-switcher" class="keditor-ui keditor-tabs">';

            if (options.showContainers === true) {
                tabs += '    <li class="keditor-ui keditor-tab active"><a class="keditor-ui" href="#keditor-container-snippets-tab"' + (options.tabTooltipEnabled ? 'data-toggle="tooltip" data-placement="bottom"' : '') + ' title="' + options.tabContainersTitle + '">' + options.tabContainersText + '</a></li>';
            }
            if (options.containerOnly === false) {
                tabs += '    <li class="keditor-ui keditor-tab ' + (options.showContainers ? '' : 'active') + '"><a class="keditor-ui" href="#keditor-component-snippets-tab"' + (options.tabTooltipEnabled ? 'data-toggle="tooltip" data-placement="bottom"' : '') + ' title="' + options.tabComponentsTitle + '">' + options.tabComponentsText + '</a></li>';
            }
            tabs += '</ul>' +
                '<div id="keditor-snippets-container" class="keditor-ui keditor-tabs-content">';

            if (options.showContainers === true) {
                tabs += '   <div class="keditor-ui keditor-tab-content active" id="keditor-container-snippets-tab"><div class="keditor-ui keditor-tab-content-inner">' + snippetsContainerHtml + '</div></div>';
            }
            if (options.containerOnly === false) {
                tabs += '   <div class="keditor-ui keditor-tab-content ' + (options.showContainers ? '' : 'active') + '" id="keditor-component-snippets-tab"><div class="keditor-ui keditor-tab-content-inner">' + snippetsComponentHtml + '</div></div>';
            }
            tabs += '</div>';
            body.find('#' + options.snippetsListId).html(tabs).addClass('loaded-snippets');
        ...
        initContainer: function (contentArea, container) {
            ...
            if (!container.hasClass('keditor-initialized-container') || !container.hasClass('keditor-initializing-container')) {
                ...
                if (options.containersEditable === true) {
                    container.append(
        ...
        initComponent: function (contentArea, container, component) {
            ...
            if (!component.hasClass('keditor-initialized-component') || !component.hasClass('keditor-initializing-component')) {
                ...
                if (options.containerOnly && isSettingEnabled) {
                    component.append(
                        '<div class="keditor-toolbar keditor-toolbar-component">' +
                        settingBtn +
                        '</div>'
                    );
                } else if (!options.containerOnly) {
                    component.append(
                        '<div class="keditor-toolbar keditor-toolbar-component">' +
        ...
        initKEditorClicks: function () {
            ...
            body.on('click', function (e) {
                ...
                if (container && options.containersEditable) {
        ...
        __init: function (options) {
            return $(this).each(function () {
                ...
                if (target.data('keditor')) {
                    ...
                    keditor.initContentAreas(target);
                } else {
